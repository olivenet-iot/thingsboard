#!/usr/bin/env python3
"""
Deploy Fault Status widget to ThingsBoard CE — SignConnect bundle.
Idempotent: safe to re-run.

Usage:
  cd /opt/thingsboard/branding/widgets/fault-status
  python3 deploy.py
...
WIDGET_DESC = "Displays D4i fault flags, DALI2 warnings, device status with real-time polling"
...
# ── Main ────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="Deploy Fault Status widget")
