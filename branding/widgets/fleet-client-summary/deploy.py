#!/usr/bin/env python3
"""
Deploy Fleet Client Summary widget to ThingsBoard SignConnect bundle.
Idempotent: safe to re-run.

Usage:
  cd /home/ubuntu/thingsboard/branding/widgets/fleet-client-summary
  python3 deploy.py
"""
...
WIDGET_FQN = "fleet_client_summary"
WIDGET_NAME = "Fleet Client Summary"
...
def main():
    ...
    print(f"  Type: latest")
    print(f"  Size: 24 x 6")
    print(f"  Fetches: status (dim_value) + tier (dashboard_tier) + signs (dimLevel) + alarms (active)")
    print(f"  Navigation: click card -> estate dashboard state")
    print("=" * 50)
