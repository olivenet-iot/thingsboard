#!/usr/bin/env python3
"""
Deploy Report Manager widget to ThingsBoard SignConnect bundle.
Idempotent: safe to re-run.

Usage:
  cd /home/ubuntu/thingsboard/branding/widgets/report
  python3 deploy.py
"""
...
WIDGET_FQN = "report_manager"
WIDGET_NAME = "Report Manager"
...
def main():
    ...
    print(f"  Type: static (no datasources)")
    print(f"  Size: 24 x 12 (full-width, tall)")
    print(f"  API: reports-service at configured URL")
    print("=" * 50)
