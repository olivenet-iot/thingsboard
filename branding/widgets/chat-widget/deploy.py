#!/usr/bin/env python3
"""
Deploy SignConnect Chat widget to ThingsBoard SignConnect bundle.
Idempotent: safe to re-run.

Usage:
  cd /home/ubuntu/thingsboard/branding/widgets/chat-widget
  python3 deploy.py
"""
...
def main():
    ...
    print(f"  Type: static (floating overlay, no datasource needed)")
    print(f"  Size: 2 x 2 (minimal footprint — UI is a fixed overlay)")
    print("=" * 50)
