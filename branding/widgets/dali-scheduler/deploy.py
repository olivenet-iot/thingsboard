...
def find_bundle(token):
    """Find existing bundle, return it or None."""
...
def main():
    ...
    checks = [
        ...
        ("templateHtml contains 'dali-scheduler'",
         "dali-scheduler" in desc.get("templateHtml", "")),
        ("templateCss contains 'slot-row-onoff'",
         "slot-row-onoff" in desc.get("templateCss", "")),
        ...
        ("controllerScript does NOT contain queryAllTasks",
         "queryAllTasks" not in desc.get("controllerScript", "")),
    ...
    print(f"  2. In widget settings, enter Device ID")
