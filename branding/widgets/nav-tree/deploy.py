#!/usr/bin/env python3
"""
Deploy Navigation Tree widget to ThingsBoard SignConnect bundle.
Idempotent: safe to re-run.

Usage:
  cd /home/ubuntu/thingsboard/branding/widgets/nav-tree
  python3 deploy.py
"""
...
def main():
    ...
    print(f"  Type: static (no datasource)")
    print(f"  Size: 4 x 12 (sidebar)")
    print(f"  Hierarchy: Estate > Region > Site > Device")
    print(f"  Navigation: state (estate/region) + dashboard (site/device)")
    print("=" * 50)
